...
const ErrorEl = () => {
  return (
    <div className="text-black h-screen items-center flex justify-center gap-5 flex-col bg-gray-50 ">
      <Helmet>
        <title>Error | Green Valley</title>
      </Helmet>
      ...
      <section className="flex flex-col w-full justify-center items-center text-gray-800">
        ...
        <div className="container flex flex-col items-center justify-center px-5 mx-auto my-8">
          <div className="max-w-md text-center">
            ...
            <p className="text-2xl text-btn-1 font-semibold md:text-3xl">
              Page Not Found!
            </p>
            ...
            <Link
              to="/"
              className="px-8 py-3 font-semibold rounded bg-btn-1 text-gray-50"
            >
              Back to homepage
            </Link>
          </div>
