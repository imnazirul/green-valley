const Footer = () => {
  return (
    <footer className="px-4 w-full divide-y bg-[#3B719799] ">
      <div className="container flex flex-col justify-between py-10 mx-auto space-y-8 lg:flex-row lg:space-y-0">
        <div className="lg:w-1/3">
          ...
          >
            <div className="flex items-center justify-center w-12 h-12 rounded-full bg-btn-1">
              <svg
            ...
            <span className="font-jost text-left self-center text-3xl font-semibold">
              Green Valley
            </span>
          </a>
      ...
      <div className="py-6 lg:text-lg text-center text-black">
        &copy; Green Valley - All rights reserved.
      </div>
    </footer>
  );
};
