const Footer = () => {
  return (
    <footer>
      <div className="px-5 p-10 lg:px-10 text-white  bg-[#0054A5]">
        <div className="footer">
          <aside>
            <div className="flex gap-1 text-[#3B7197]">
              <h3 className="text-3xl font-jost text-[#FAFDFB] font-bold">
                Green Valley
              </h3>
            </div>
      ...
      <div className="footer items-center p-5 px-10  text-neutral-content bg-btn-1">
